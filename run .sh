...
python3 LLM_taxonomy_enrichment.py --data_dir data/ --dataset Amazon-531 

# Initial core class annotation (need OpenAI API)
# input: llm enrichment
# output: train/init_core_classes.json
python3 core_class_annotation.py --data_dir data/ --dataset Amazon-531  --gpu ${gpu}
...
python3 taxonomy_enrichment.py --data_dir data/ --dataset Amazon-531  --gpu ${gpu}


# Section 3.3: Core Class Refinement
# input: initial core classes, enriched taxonomy
# output: train/refined_core_classes.json
python3 core_class_refinement.py --data_dir data/ --dataset Amazon-531  --gpu ${gpu}
...
python3 generation.py --data_dir data/ --dataset Amazon-531 


# Text classifier training
# input: refined core classes and generated documents
# output: trained classifier at: train/model.pt
python3 prepare_training_data.py --data_dir data/ --dataset Amazon-531  --gpu ${gpu}
python3 classifier_training.py --data_dir data/ --dataset Amazon-531  --gpu ${gpu}


# Evaluation, if a test set is available
# need: test/corpus.txt & test/doc2labels.txt
python3 eval_classifier.py --data_dir data/ --dataset Amazon-531  --gpu ${gpu} --model_pth data/Amazon-531 /train/model.pt